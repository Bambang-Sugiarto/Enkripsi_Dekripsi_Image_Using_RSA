...
% Last Modified by GUIDE v2.5 02-Nov-2020 11:14:31
...
axs = axes('unit','normalized','position',[0 0 1 1]);
bg = imread('icon_bg\home2.jpg');
imagesc(bg);
set(axs,'handlevisibility','off','visible','off');
